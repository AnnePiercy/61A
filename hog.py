...
def free_bacon(score):
    ...
    bacon_score = 2 + abs(first_digit - second_digit)
    return bacon_score
    # END PROBLEM 2
    ...
    def say(score0, score1):
        ...
        if score_difference > previous_high:
            if score_difference == 1:
                print(score_difference, "point! That's the biggest gain yet for Player",    who)
            else:
                print(score_difference, "points! That's the biggest gain yet for Player", who)
            return announce_highest(who, score_difference, score0 if who == 0 else score1)
        return announce_highest(who, previous_high, score0 if who == 0 else score1)
    return say
    # END PROBLEM 7
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    highest_roll = 0
    while i <= 10:
        current_test = average(i, dice)
        if current_test > previous_max:
            previous_max = current_test
            highest_roll = i
        i += 1
    return highest_roll
    # END PROBLEM 9
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    if (is_swap(bacon_score, opponent_score) and opponent_score > bacon_score
        or bacon_strategy(score, opponent_score, margin, num_rolls) == 0):
        return 0
    else:
        return num_rolls
    # END PROBLEM 11
